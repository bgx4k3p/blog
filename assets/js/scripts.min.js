!function(){for(var e=document.querySelectorAll("h1[id],h2[id],h3[id],h4[id],h5[id],h6[id]"),t=0;t<e.length;t++){var i=document.createElement("img"),r=(i.setAttribute("src","/blog/assets/img/link-symbol.svg"),document.createElement("a"));r.setAttribute("href","#"+e[t].getAttribute("id")),r.classList.add("anchor"),r.appendChild(i),e[t].insertBefore(r,e[t].firstChild)}}();
...
!function(c){c.fn.simpleJekyllSearch=function(e){var s=c.extend({jsonFile:"/blog/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}"><span class="entry-category">{categories}</span> {title} <span class="entry-date"><time datetime="{date}">{date}</time></span></a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! We didn't find anything :(</p>"},e),a=s.jsonFormat.split(","),o=[],l=this,i=c(s.searchResults);function r(){i.children().remove()}s.jsonFile.length&&i.length&&c.ajax({type:"GET",url:s.jsonFile,dataType:"json",success:function(e,t,n){o=e,l.keyup(function(e){var t,n,l;c(this).val().length?(n=c(this).val(),l=[],c.each(o,function(e,t){for(e=0;e<a.length;e++)void 0!==t[a[e]]&&-1!==t[a[e]].toLowerCase().indexOf(n.toLowerCase())&&(l.push(t),e=a.length)}),t=l,r(),i.append(c(s.searchResultsTitle)),t.length?c.each(t,function(e,t){if(e<s.limit){for(var n=s.template,e=0;e<a.length;e++)var l=new RegExp("{"+a[e]+"}","g"),n=n.replace(l,t[a[e]]);i.append(c(n))}}):i.append(s.noResults)):r()})},error:function(e,t,n){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(t),console.log(n)}})}}(Zepto);
